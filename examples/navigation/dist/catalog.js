...
},{"./emptyFunction":12,"_process":54}],22:[function(require,module,exports){
"use strict";
...
var withStateNavigator_1 = require("./withStateNavigator");
var React = require("react");
var NavigationBackLink = /** @class */ (function (_super) {
    ...
    NavigationBackLink.prototype.render = function () {
        ...
        props.onClick = LinkUtility_1["default"].getOnClick(this.getStateNavigator(), this.props, this.state.link);
        return React.createElement("a", __assign({}, props), this.props.children);
    };
...
;
exports["default"] = withStateNavigator_1["default"](NavigationBackLink);

},{"./LinkUtility":22,"./withStateNavigator":29,"react":71}],24:[function(require,module,exports){
"use strict";
exports.__esModule = true;
var navigation_1 = require("navigation");
var React = require("react");
var navigationContext;
var defaultValue = { oldState: null, state: null, data: {}, stateNavigator: new navigation_1.StateNavigator(), defaultValue: true };
...
},{"navigation":52,"react":71}],25:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var NavigationHandler = /** @class */ (function (_super) {
    ...
    NavigationHandler.prototype.render = function () {
        ...
        return (React.createElement(NavigationContext_1["default"].Provider, { value: { oldState: oldState, state: state, data: data, asyncData: asyncData, stateNavigator: stateNavigator } }, children));
    };
    return NavigationHandler;
}(React.Component));
exports["default"] = NavigationHandler;

},{"./NavigationContext":24,"react":71}],26:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var withStateNavigator_1 = require("./withStateNavigator");
var React = require("react");
var NavigationLink = /** @class */ (function (_super) {
    ...
    NavigationLink.prototype.getComponentState = function (props) {
        ...
        var active = state && state.key === stateKey && LinkUtility_1["default"].isActive(this.getStateNavigator(), navigationData);
    ...
    NavigationLink.prototype.getNavigationLink = function (props) {
        ...
        var navigationData = LinkUtility_1["default"].getData(this.getStateNavigator(), navigationData, includeCurrentData, currentDataKeys);
        try {
    ...
    NavigationLink.prototype.render = function () {
        ...
        props.href = this.state.link && this.getStateNavigator().historyManager.getHref(this.state.link);
        props.onClick = LinkUtility_1["default"].getOnClick(this.getStateNavigator(), this.props, this.state.link);
        LinkUtility_1["default"].setActive(this.state.active, this.props, props);
        return React.createElement("a", __assign({}, props), this.props.children);
    };
...
;
exports["default"] = withStateNavigator_1["default"](NavigationLink);

},{"./LinkUtility":22,"./withStateNavigator":29,"react":71}],27:[function(require,module,exports){
"use strict";
exports.__esModule = true;
var NavigationContext_1 = require("./NavigationContext");
exports.NavigationContext = NavigationContext_1["default"];
var NavigationHandler_1 = require("./NavigationHandler");
exports.NavigationHandler = NavigationHandler_1["default"];
...
},{"./NavigationBackLink":23,"./NavigationContext":24,"./NavigationHandler":25,"./NavigationLink":26,"./RefreshLink":28}],28:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var withStateNavigator_1 = require("./withStateNavigator");
var React = require("react");
var RefreshLink = /** @class */ (function (_super) {
    ...
    RefreshLink.prototype.getComponentState = function (props) {
        ...
        var active = LinkUtility_1["default"].isActive(this.getStateNavigator(), navigationData);
        return { link: link, active: active };
    };
...
;
exports["default"] = withStateNavigator_1["default"](RefreshLink);

},{"./LinkUtility":22,"./withStateNavigator":29,"react":71}],29:[function(require,module,exports){
"use strict";
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
...
var NavigationContext_1 = require("./NavigationContext");
var React = require("react");
exports["default"] = function (Link) { return function (props) { return (React.createElement(NavigationContext_1["default"].Consumer, null, function (_a) {
    var stateNavigator = _a.stateNavigator, defaultValue = _a.defaultValue;
    return React.createElement(Link, __assign({ stateNavigator: stateNavigator, navigationContext: !defaultValue }, props));
})); }; };

},{"./NavigationContext":24,"react":71}],30:[function(require,module,exports){
module.exports = require('./lib/NavigationReact');

},{"./lib/NavigationReact":27}],31:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./StateContext":34,"./config/Crumb":38}],32:[function(require,module,exports){
"use strict";
exports.__esModule = true;
var StateContext_1 = require("./StateContext");
exports.StateContext = StateContext_1["default"];
var StateNavigator_1 = require("./StateNavigator");
exports.StateNavigator = StateNavigator_1["default"];
var State_1 = require("./config/State");
exports.State = State_1["default"];
var HashHistoryManager_1 = require("./history/HashHistoryManager");
exports.HashHistoryManager = HashHistoryManager_1["default"];
var HTML5HistoryManager_1 = require("./history/HTML5HistoryManager");
exports.HTML5HistoryManager = HTML5HistoryManager_1["default"];
var Crumb_1 = require("./config/Crumb");
exports.Crumb = Crumb_1["default"];

},{"./StateContext":34,"./StateNavigator":36,"./config/Crumb":38,"./config/State":39,"./history/HTML5HistoryManager":47,"./history/HashHistoryManager":48}],33:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./converter/ConverterFactory":42}],34:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./NavigationDataManager":33,"./StateRouter":37,"./config/Crumb":38,"./config/State":39}],36:[function(require,module,exports){
"use strict";
exports.__esModule = true;
var Crumb_1 = require("./config/Crumb");
...
},{"./FluentNavigator":31,"./StateContext":34,"./StateHandler":35,"./config/Crumb":38,"./history/HashHistoryManager":48}],37:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./routing/Router":50}],38:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./TypeConverter":46}],41:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./TypeConverter":46}],42:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./ArrayConverter":40,"./BooleanConverter":41,"./DateConverter":43,"./NumberConverter":44,"./StringConverter":45}],43:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./TypeConverter":46}],44:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./TypeConverter":46}],45:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./TypeConverter":46}],46:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
var Route = /** @class */ (function () {
    ...
    Route.prototype.parse = function () {
        ...
        for (var i = 0; i < subPaths.length; i++) {
            segment = new Segment_1["default"](subPaths[i], segment ? segment.optional : true, this.defaults);
...
},{"./Route":49}],51:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"./lib/Navigation":32}],53:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./lib/ReactPropTypesSecret":59,"_process":54,"fbjs/lib/invariant":17,"fbjs/lib/warning":21}],56:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":59,"fbjs/lib/emptyFunction":12,"fbjs/lib/invariant":17}],57:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":55,"./lib/ReactPropTypesSecret":59,"_process":54,"fbjs/lib/emptyFunction":12,"fbjs/lib/invariant":17,"fbjs/lib/warning":21,"object-assign":53}],58:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"react-transition-group/CSSTransitionGroup":64}],61:[function(require,module,exports){
(function (process){
...
},{"_process":54,"fbjs/lib/ExecutionEnvironment":8,"fbjs/lib/camelizeStyleName":10,"fbjs/lib/containsNode":11,"fbjs/lib/emptyFunction":12,"fbjs/lib/emptyObject":13,"fbjs/lib/getActiveElement":14,"fbjs/lib/hyphenateStyleName":16,"fbjs/lib/invariant":17,"fbjs/lib/shallowEqual":20,"fbjs/lib/warning":21,"object-assign":53,"prop-types/checkPropTypes":55,"react":71}],62:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/ExecutionEnvironment":8,"fbjs/lib/containsNode":11,"fbjs/lib/emptyFunction":12,"fbjs/lib/emptyObject":13,"fbjs/lib/getActiveElement":14,"fbjs/lib/invariant":17,"fbjs/lib/shallowEqual":20,"object-assign":53,"react":71}],63:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./CSSTransitionGroupChild":65,"./TransitionGroup":66,"./utils/PropTypes":68,"_process":54,"prop-types":58,"react":71}],65:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./utils/PropTypes":68,"_process":54,"dom-helpers/class/addClass":2,"dom-helpers/class/removeClass":4,"dom-helpers/transition/properties":5,"dom-helpers/util/requestAnimationFrame":7,"prop-types":58,"react":71,"react-dom":63}],66:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./utils/ChildMapping":67,"_process":54,"chain-function":1,"prop-types":58,"react":71,"warning":72}],67:[function(require,module,exports){
'use strict';
...
},{"react":71}],68:[function(require,module,exports){
'use strict';
...
},{"prop-types":58,"react":71}],69:[function(require,module,exports){
(function (process){
/** @license React v16.3.2
...
},{"_process":54,"fbjs/lib/emptyFunction":12,"fbjs/lib/emptyObject":13,"fbjs/lib/invariant":17,"fbjs/lib/warning":21,"object-assign":53,"prop-types/checkPropTypes":55}],70:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/emptyFunction":12,"fbjs/lib/emptyObject":13,"fbjs/lib/invariant":17,"object-assign":53}],71:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":69,"./cjs/react.production.min.js":70,"_process":54}],72:[function(require,module,exports){
(function (process){
/**
...
},{"_process":54}],73:[function(require,module,exports){
'use strict';
...
},{"navigation-react":30,"react":71}],74:[function(require,module,exports){
'use strict';
...
},{"./Albums.js":73,"./Info.js":75,"./Search.js":76,"./Tracks.js":77,"react":71}],75:[function(require,module,exports){
"use strict";
...
},{"react":71}],76:[function(require,module,exports){
'use strict';
...
},{"navigation-react":30,"react":71}],77:[function(require,module,exports){
'use strict';
